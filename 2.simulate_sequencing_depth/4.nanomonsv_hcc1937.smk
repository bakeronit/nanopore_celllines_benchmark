...
rule all:
    input:
        ...
        #expand("analysis/svs/nanomonsv/{sample_t}.60x.HCC1937_BL.60x/{sample_t}.60x.HCC1937_BL.60x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]),
        #expand("analysis/svs/nanomonsv/{sample_t}.45x.HCC1937_BL.45x/{sample_t}.45x.HCC1937_BL.45x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]),
        #expand("analysis/svs/nanomonsv/{sample_t}.30x.HCC1937_BL.30x/{sample_t}.30x.HCC1937_BL.30x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]),
        #expand("analysis/svs/nanomonsv/{sample_t}.15x.HCC1937_BL.15x/{sample_t}.15x.HCC1937_BL.15x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]) 
        #
        #expand("analysis/svs/nanomonsv/{sample_t}.60x.HCC1937_BL.45x/{sample_t}.60x.HCC1937_BL.45x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]),
        #expand("analysis/svs/nanomonsv/{sample_t}.45x.HCC1937_BL.30x/{sample_t}.45x.HCC1937_BL.30x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]),
        #expand("analysis/svs/nanomonsv/{sample_t}.30x.HCC1937_BL.15x/{sample_t}.30x.HCC1937_BL.15x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]),
        #
        expand("analysis/svs/nanomonsv/{sample_t}.60x.HCC1937_BL.30x/{sample_t}.60x.HCC1937_BL.30x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]),
        expand("analysis/svs/nanomonsv/{sample_t}.45x.HCC1937_BL.15x/{sample_t}.45x.HCC1937_BL.15x.nanomonsv.result.txt", sample_t=hcc1937_samples[:-1]),
