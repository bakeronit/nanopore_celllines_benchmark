...
df_lr_unique |> filter(svtype!="TRA") |> mutate(Type=case_when(suppvec=="11"~"Concordant", suppvec=="10"~"FN (SR unique)", suppvec=="01" ~ "FP (LR unique)" )) |> group_by(svtype, Type) |> rename("SV type"=svtype) |> 
