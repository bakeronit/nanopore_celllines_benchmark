...
the gnomAD database using script
[gnomad_anno.py](../../1.dna_mixing_celllines/scripts/gnomad_anno.py).
Note that this is just a rough estimate which help me to compare across
conditions.
