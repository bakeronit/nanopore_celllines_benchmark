...
rule jasmine_merge:
    ...
    params:
        gs = lambda wildcards: f"../../../structural_variation/analysis/svs/jasmine_merge/{wildcards.sample_t.lower().split("_")[0]}/{wildcards.sample_t.lower().split("_")[0]}.final_merged.supp2_dupToIns.vcf",
