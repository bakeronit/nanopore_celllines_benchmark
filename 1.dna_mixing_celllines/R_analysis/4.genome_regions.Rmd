...
For SNV, I would like to check if there are clusters of specific calls in certain region. First visualise in a raindrop plot, then separate them by chromosomes.
