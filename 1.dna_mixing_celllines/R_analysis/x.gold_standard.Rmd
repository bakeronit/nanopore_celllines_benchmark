...
- Firstly, I call SV using [lumpy](https://github.com/arq5x/lumpy-sv), [gridss](https://github.com/PapenfussLab/gridss), and [delly](https://github.com/dellytools/delly) using the [workflow](../../gs/workflow).
